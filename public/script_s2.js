...
text[2] = document.getElementById("texts1")
...
socket.on("datafunc", function (data) {
    ...
    move(s[2].value, barra1, value1, maxvalue1, minvalue1, s[2].max, s[2].unit, 2)
})
...
function startbar() {
    sliderbar.value = r[2].min
    sliderbarb.value = r[2].max
    maxvalue1.style.bottom = 430 + "px"
    minvalue1.textContent = "0.00"
    maxvalue1.textContent = s[2].max + ".00"
}
...
contact1.oninput = function () {
    contact()
    sendRELAYdata(sliderbar.value, sliderbarb.value, r[2].cont)
    movebar()
}
...
function contact() {
    ...
    if (r[2].cont == "NA") {
        ...
        barralim1[2].style.display = "block"
        barralim2[2].style.display = "none"
    }
    if (r[2].cont == "NC") {
        sliderbar.disabled = false
    ...
    if (r[2].cont == "VNC") {
        ...
        inferior.textContent = "l" + it + "mite superior:"
        barralim1[2].style.display = "block"
        barralim2[2].style.display = "block"
    }
    if (r[2].cont == "NAH") {
        sliderbar.disabled = false
        sliderbarb.disabled = false
...
function moveslider() {
    if (sliderbar.value >= sliderbarb.value && (r[2].cont == "VNC" || r[2].cont == "VNA" || r[2].cont == "NAH" || r[2].cont == "NCH")) {
...
function movebar() {
    if (r[2].cont == "NA") {
        ...
        barralim1[2].style.top = 0 + "px";
        barralim1[2].style.height = 401 - a + "px";
    }
    if (r[2].cont == "NC") {
        a = sliderbar.value * 0.401
        barralim1[2].style.top = 401-a + "px";
        barralim1[2].style.height =  a + "px";
    }
    if (r[2].cont == "VNA") {
        a = sliderbar.value * 0.401
        b = sliderbarb.value * 0.401
        barralim1[2].style.top = 401-b + "px";
        barralim1[2].style.height = b-a + "px";
    }
    if (r[2].cont == "VNC") {
        a = sliderbar.value * 0.401
        barralim1[2].style.top = 401 - a + "px";
        ...
        b = sliderbarb.value * 0.401
        barralim2[2].style.top = 0 + "px";
        barralim2[2].style.height = 401 - b + "px";
    }
    if (r[2].cont == "NAH") {
        a = sliderbar.value * 0.401
        b = sliderbarb.value * 0.401
...
function editar() {
    text[2].readOnly = false
    text[2].style.border = "solid";
}

function defaultevent() {
    if (text[2].value != original) {
        text[2].readOnly = true
        text[2].style.border = "none";
        sendJSONdata(text[2].value)
        
    }
    nav[2].innerHTML = text[2].value
    original = text[2].value
}
