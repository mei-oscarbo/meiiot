...
text[1] = document.getElementById("texts1")
...
function startbar() {
    sliderbar.value = r[1].min
    sliderbarb.value = r[1].max
    maxvalue1.style.bottom = 430 + "px"
    minvalue1.textContent = "0.00"
    maxvalue1.textContent = s[1].max + ".00"
}
...
contact1.oninput = function () {
    contact()
    sendRELAYdata(sliderbar.value, sliderbarb.value, r[1].cont)
    movebar()
}
...
function contact() {
    ...
    if (r[1].cont == "NA") {
        ...
        barralim1[1].style.display = "block"
        barralim2[1].style.display = "none"
    }
    if (r[1].cont == "NC") {
        sliderbar.disabled = false
    ...
    if (r[1].cont == "VNC") {
        ...
        inferior.textContent = "l" + it + "mite superior:"
        barralim1[1].style.display = "block"
        barralim2[1].style.display = "block"
    }
    if (r[1].cont == "NAH") {
        sliderbar.disabled = false
        sliderbarb.disabled = false
...
function moveslider() {
    if (sliderbar.value >= sliderbarb.value && (r[1].cont == "VNC" || r[1].cont == "VNA" || r[1].cont == "NAH" || r[1].cont == "NCH")) {
...
function movebar() {
    if (r[1].cont == "NA") {
        ...
        barralim1[1].style.top = 0 + "px";
        barralim1[1].style.height = 401 - a + "px";
    }
    if (r[1].cont == "NC") {
        a = sliderbar.value * 0.401
        barralim1[1].style.top = 401-a + "px";
        barralim1[1].style.height =  a + "px";
    }
    if (r[1].cont == "VNA") {
        a = sliderbar.value * 0.401
        b = sliderbarb.value * 0.401
        barralim1[1].style.top = 401-b + "px";
        barralim1[1].style.height = b-a + "px";
    }
    if (r[1].cont == "VNC") {
        a = sliderbar.value * 0.401
        barralim1[1].style.top = 401 - a + "px";
        ...
        b = sliderbarb.value * 0.401
        barralim2[1].style.top = 0 + "px";
        barralim2[1].style.height = 401 - b + "px";
    }
    if (r[1].cont == "NAH") {
        a = sliderbar.value * 0.401
        b = sliderbarb.value * 0.401
...
function editar() {
    text[1].readOnly = false
    text[1].style.border = "solid";
}

function defaultevent() {
    if (text[1].value != original) {
        text[1].readOnly = true
        text[1].style.border = "none";
        sendJSONdata(text[1].value)
        
    }
    nav[1].innerHTML = text[1].value
    original = text[1].value
}
